...
- Updated release metadata across Cargo, Qt CMake, packaging files, README, and release guidance to `1.0.2`
- Prepared the repository for the `v1.0.2` production release tag
