...
type RowMenuCallback = Rc<dyn Fn()>;

#[derive(Clone, Default)]
struct RowMenuCallbacks {
    on_edit: Option<RowMenuCallback>,
    on_duplicate: Option<RowMenuCallback>,
    on_delete: Option<RowMenuCallback>,
}
...
impl ResultGrid {
    pub fn new() -> Self {
        ...
        Self {
            ...
            crud_enabled: Rc::new(RefCell::new(false)),
            row_menu: Rc::new(RefCell::new(RowMenuCallbacks::default())),
        }
    }
